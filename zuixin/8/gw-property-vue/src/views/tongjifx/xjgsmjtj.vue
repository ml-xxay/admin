  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.tableheader = "县级公司规划测算模型"; //头部标题
        ...
        this.$requestsu.post("/TM_model_city_getsubcompanyhousecalculate_controller_county", formData).then(function(
            response) {
