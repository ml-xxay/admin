    ...
    <div :class="['ele-pro-table ele-bg-white', {'ele-pro-table-fullscreen': isFullscreen}]"
      ...
      <el-card shadow="never">
        ...
        <el-table ref="table" v-if="refresh" :indent="5" :height="fullscreenheight"
          :header-cell-style="{textAlign: 'center'}" :data="tableData" border>
          <el-table-column align="center" prop="c" label="公司名称" sortable min-width="150px" fixed="left">
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.tableheader = "市级公司规划测算模型"; //头部标题
        ...
        this.$requestsu.post("/TM_model_province_getsubcompanyhousecalculate_controller_county", formData).then(
            function(response) {
