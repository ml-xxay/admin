          ...
          <el-row :gutter="15">
            ...
            <el-col :md="15" :sm="12">
              <el-form-item label="在建起止日期:" label-width="100px" v-if="ZAIJIAN">
                <el-date-picker size="mini" clearable style="width:350px !important"
                  v-model="DATERANGE"
                  type="daterange"
  ...
  export default {
    ...
    methods: {
      ...
      exportBas() {
        ...
        sheet['!merges'] = [{s: {r: 0,c: 0},e: {r: 1,c: 0}}, {s: {r: 0,c: 1},e: {r: 1,c: 1}}, {s: {r: 0,c: 2},e: {r: 0,c: 4}}, {s: {r: 0,c: 5},e: {r: 0,c: 6}}, {s: {r: 0,c: 7},e: {r: 1,c: 7}}, {s: {r: 0,c: 8},e: {r: 0,c: 9}}, {s: {r: 0,c: 10},e: {r: 0,c: 11}}, {s: {r: 0,c: 12},e: {r: 1,c: 12}}, {s: {r: 0,c: 13},e: {r: 1,c: 13}}, {s: {r: 0,c: 14},e: {r: 0,c: 16}}, {s: {r: 0,c: 17},e: {r: 0,c: 19}}, {s: {r: 0,c: 20},e: {r: 1,c: 20}}, {s: {r: 0,c: 21},e: {r: 1,c: 21}}, {s: {r: 0,c: 22},e: {r: 1,c: 22}}, {s: {r: 0,c: 23},e: {r: 1,c: 23}}];
        ...
        for (var i = 1; i < ncols + 1; i++) {
          ...
          for (var k = 1; k < nrows + 1; k++) {
            ...
            if (sheet[curr] != undefined) {
              sheet[curr].s = {font: {name: '宋体',sz: 11,bold: false,color: {rgb: "000"},},alignment: {horizontal: "center",vertical: "center",wrapText: true,},border: {top: {style: "thin",},bottom: {style: "thin",},left: {style: "thin",},right: {style: "thin",},}}
            }
          }
        }
