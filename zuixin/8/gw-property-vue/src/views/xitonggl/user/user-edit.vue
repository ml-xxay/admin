    ...
    <el-form
      ...
      <el-row :gutter="15">
        <el-col :sm="20">
          ...
          <el-form-item label="所属公司:"  style="width: 465px">
            <treeselect
...
export default {
  ...
  data() {
    return {
      ...
      addfromrules: {
        ...
        FANGKE: [
          {required: true, message: '请选择是否访客', trigger: 'blur'},
        ],
        ZHUANGTAI: [
  ...
  watch: {
    data() {
      if (this.data) {
        this.form = this.data
        this.form.YONGHUQUANXIAN = this.data.YONGHUQUANXIAN.toString()
        this.isUpdate = true;
      } else {
        this.form = {};
        this.isUpdate = false;
    ...
    save() {
      if (this.form.ZHANGHAO === null || this.form.ZHANGHAO === '') {
        ...
        if (this.isUpdate) {
          ...
          formData.append('ZHANGHAO', this.form.ZHANGHAO!=null?this.form.ZHANGHAO:"")
          formData.append('MIMA', this.form.MIMA!=null?this.form.MIMA:"")
          formData.append('GONGSIID', this.form.GONGSIID!=null?this.form.GONGSIID:"")
          formData.append('YONGHUQUANXIAN', this.form.YONGHUQUANXIAN!=null?this.form.YONGHUQUANXIAN:"")
          formData.append('FANGKE', this.form.FANGKE!=null?this.form.FANGKE:"")
          formData.append('ZHUANGTAI', this.form.ZHUANGTAI!=null?this.form.ZHUANGTAI:"")
