...
<template>
  <div class="ele-admin-header-tool">
    ...
    <!-- 语言切换 -->
    <div class="ele-admin-header-tool-item" style="display: none;">
    ...
    <div class="ele-admin-header-tool-item">
      <el-dropdown @command="onUserDropClick">
        <div class="ele-admin-header-avatar">
          <el-avatar :src="loginUser.avatar"  style="display: none;"/>
          <span>{{ loginUser.nickname }}</span>
          <i class="el-icon-arrow-down"></i>
        </div>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="profile" icon="el-icon-user"  style="display: none;">
