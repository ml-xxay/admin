  ...
  <div class="ele-body">
    <el-card shadow="never">
        ...
        <el-row :gutter="15">
          ...
          <el-col :md="6" :sm="12" >
            <el-form-item label="所属房产">
              <el-select clearable v-model="FANGCHANID" placeholder="请选择所属房产" style="width: 270px;">
      ...
      <el-table  v-if="refresh" ref="table" row-key="ID" border @cell-click="tableCellClick"
        default-expand-all :cell-class-name="
      ...
      " :data="tableData" style="width: 100%;margin-top: 0px">
        ...
        <el-table-column prop="ZIXIANGER" label="子项二" width="200">
        </el-table-column>
      ...
      getData() {
        ...
        this.$http.post(this.serviceurl + '/TM_getallinfo_controller', {
          ...
          this.$http.post(this.serviceurl + '/TM_getallinfo_controller', {
            ...
            equalmap: JSON.stringify({"GONGSILX": myutils.getGONGSILXNAME(this.GONGSILX)}),
