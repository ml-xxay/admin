  ...
  methods: {
    ...
    save() {
      ...
      if (this.isUpdate) {
        ...
        formData.append('FANGCHANID', this.form.FANGCHANID)
        formData.append('BIAOZHUNID', this.form.BIAOZHUNID)
        formData.append('MIANJISHUZHI', this.form.MIANJISHUZHI)
        formData.append('RENSHU', this.form.RENSHU)
