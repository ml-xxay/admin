    ...
    <el-form
      ...
      <el-row :gutter="15">
        <el-col :sm="12">
          ...
          <el-form-item label="公司ID:" prop="SHEZHIGSID" style="display: none">
            <el-input
              clearable
              :maxlength="20"
          ...
          <el-form-item label="公司类型:" prop="GONGSILX">
            <el-select
              ...
              placeholder="请选择公司类型">
              <el-option label="国家电网" value="0"/>
              <el-option label="一类公司" value="1"/>
              <el-option label="二类公司" value="2"/>
              <el-option label="三类公司 " value="3"/>
          ...
          <el-form-item style="margin-left: -30px" label="年售电量:" label-width="120px" prop="NIANSHOUDIANLIANG">
            <div style="display: flex;justify-content: center;width: 300px">
              <el-input
                ...
                placeholder="请输入年售电量"/>
              <div style="margin-left: 10px">(亿度)</div>
            </div>
          </el-form-item>
          ...
          <el-form-item label="序号:" prop="XUHAO">
            ...
            <el-input-number style="width: 170px"
