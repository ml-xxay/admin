  ...
  <div class="ele-body">
    <el-card shadow="never">
			...
			<el-row :gutter="15">
				<el-col :md="5" :sm="12">
					<el-form-item label="公司类型">
						<el-select clearable v-model="selGONGSILX" placeholder="请选择公司类型">
      ...
      <el-table  v-if="refresh" ref="table" row-key="ID"
        border @cell-click="tableCellClick" :cell-class-name="
    ...
    " :data="tableData" style="width: 100%;margin-top: 0px">
        ...
        <el-table-column prop="GONGNENGYF" label="功能用房" minWidth="170">
          <template slot-scope="scope">
            <span v-if="
            scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="ZIXIANGYI" label="子项一" minWidth="170">
          <template slot-scope="scope">
            <span v-if="
            scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="ZIXIANGER" label="子项二" minWidth="130">
          <template slot-scope="scope">
            <span v-if="
            scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="SHIFOUSJXFGSYWFB" width="95" label="是否省检修（分）公司运维分部">
          <template slot-scope="scope">
            <span v-if="
            scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
