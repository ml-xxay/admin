  ...
  data() {
    return {
      ...
      rules: {
        ...
        SHIWUID: [
          {required: true, message: '请输入实物ID编码', trigger: 'blur'}
        ],
        FANGCHANMC: [
        ...
        SUOSHUTUDI: [
          {required: true, message: '请输入所属土地', trigger: 'blur'}
        ],

        FANGCHANLAIYUAN: [
          {required: true, message: '请输入房产来源', trigger: 'blur'}
        ],
        TOURUSHIYONGSJ: [
        ...
        BUSHIYI: [
          {required: true, message: '请选是否适宜房', trigger: 'blur'}
        ],
        WEIFANG: [
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if (this.isUpdate) {
            ...
            formData.append('SHIWUID', this.form.SHIWUID)
            formData.append('FANGCHANMC', this.form.FANGCHANMC)
            formData.append('FANGCHANBH', this.form.FANGCHANBH)
            formData.append('DIZHI', this.form.DIZHI)
            formData.append('FANGCHANLAIYUAN', this.form.FANGCHANLAIYUAN)
            formData.append('TOURUSHIYONGSJ', this.getLocalTime(this.form.TOURUSHIYONGSJ))
            formData.append('SHIYONGZHUANGTAI', this.form.SHIYONGZHUANGTAI)
            formData.append('ZAIJIAN', this.form.ZAIJIAN)
            formData.append('NICHAIQIAN', this.form.NICHAIQIAN)
            formData.append('BUSHIYI', this.form.BUSHIYI)
            formData.append('WEIFANG', this.form.WEIFANG)
            formData.append('MIANJI', this.form.MIANJI)
            formData.append('SUOSHUTUDI', this.form.SUOSHUTUDI)
