  ...
  <div class="ele-body">
    <el-card shadow="never">
        ...
        <el-row :gutter="15">
          <el-col :md="5" :sm="12">
            <el-form-item label="公司类型:" prop="GONGSILX">
              <el-select clearable class="ele-block" v-model="GONGSILX" placeholder="请选择公司类型">
      ...
      " :data="tableData" style="width: 100%;margin-top: 0px">
        ...
        <el-table-column prop="GONGSILX" label="公司类型" width="110" :formatter="formatterLX">
        </el-table-column>
        <el-table-column prop="GUIMOFL" label="公司规模" width="110">
        </el-table-column>

        <el-table-column prop="DIAODUSCGLYFMJ" label="调度生产管理用房面积" minWidth="170">
        ...
        <el-table-column prop="YUNWEIJXYFMJ" label="运维检修用房面积" minWidth="140">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="YINGXIAOYFMJ" label="营销用房面积" minWidth="120">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="DANGANKFMJ" label="档案库房面积" minWidth="120">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="ZONGHEGUANLIMJXS" label="综合管理面积系数" minWidth="140">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="SHITANGMJXS" label="食堂面积系数" minWidth="120">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="NIJIANFANGSHU" label="拟建房数" minWidth="100">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="SHEBEISHEZHIYFMJ" label="设备设施用房面积" minWidth="140">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        this.$http.post(this.serviceurl + '/TM_getallinfo_controller', {
          ...
          this.$http.post(this.serviceurl + '/TM_getallinfo_controller', {
            ...
            equalmap: JSON.stringify({
              "GONGSIID": this.SHEZHIGSID,
              "GONGSILX": this.GONGSILX
            }),
            ...
            this.GONGSIGUIMO = res.data.data; //在系数设定数据表中  查找 选中公司类型后 的数据
