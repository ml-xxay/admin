...
<script>
import UserEdit from './gongsi/gongsi-edit.vue';
import UserImport from './gongsi/gongsi-import.vue';
  ...
  data() {
    return {
      ...
      where: {
        ...
        orderarray: JSON.stringify([{"GONGSILX": "ASC","FUJIID":"ASC","GONGSIGUIMOID":"ASC","ID":"ASC"}]),
        secondsearch: JSON.stringify(
          [
            ...
            {
              "condition": "GONGSIGUIMOID",//公司规模ID
              "targettable": "TMDB_PMS_GONGSIGUIMO",//到规模表里面
              "targetcolumn": "GUIMOFL",//查寻规模分类
              "returnname": "COMGUIMOFL"//赋值给COMGUIMOFL
            }
          ]
        ),
      },
