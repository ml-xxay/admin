...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          //处理数据
          formatter: (row) => {
            return myutils.getfangchanshuxing(row.FANGCHANSX)
          }
        },
  ...
  methods: {
    /* 刷新表格 */
    reloads() {
      this.where.likemap = JSON.stringify({"FANGCHANBH": this.where.FANGCHANBH, "FANGCHANMC": this.where.FANGCHANMC})
