  ...
  <div class="ele-body">
    <el-card shadow="never">
      ...
      " :data="tableData" style="width: 100%;margin-top: 0px">
        ...
        <el-table-column prop="DIAODUSCGLYFMJ" label="调度生产管理用房面积" minWidth="180">
        ...
        <el-table-column prop="YUNWEIJXYFMJ" label="运维检修用房面积" minWidth="150">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="YINGXIAOYFMJ" label="营销用房面积" minWidth="130">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
        ...
        <el-table-column prop="SHEBEISHEZHIYFMJ" label="设备设施用房面积系数" minWidth="170">
          <template slot-scope="scope">
            <span v-if="
              scope.row.index === tableCellClickRowIndex && scope.column.index === tableCellClickColumnIndex ">
